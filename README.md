...
```
카페 공차의 모바일웹과 앱을 참조하여 전반적인 UI를 구성하였고 스마트 오더 기능을 추가로 구현했습니다.
로그인 시 현재 위치 정보를 받아서 가장 가까운 매장을 보여주고 선택할 수 있게 했습니다.
...
[![커스텀 음료 주문 모바일웹 시연 영상](http://img.youtube.com/vi/pkfz51tCebQ/0.jpg)](https://youtu.be/pkfz51tCebQ?t=0s)
